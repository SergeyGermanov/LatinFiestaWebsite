...
var localStratagy = new localStratagy(function(username, password, done) {
...
app.get("/" || "/index", function(req, res) {
  ...
  query(
    'SELECT "article_ID", "content" FROM "article" WHERE "article_ID"=\'1\'',
    [],
    function(err, rows) {
...
app.get("/entertainment", function(req, res) {
  ...
  query(
    'SELECT "article_ID", "content" FROM "article" WHERE "article_ID" = \'3\'',
    [],
    function(err, rows) {
      var articles = rows.rows;
      var data = {
...
app.get("/food", function(req, res) {
  ...
  query(
    'SELECT "article_ID", "content" FROM "article" WHERE "article_ID" = \'2\'',
    [],
    function(err, rows) {
      var articles = rows.rows;
...
app.get("/freeclasses", function(req, res) {
  ...
  query(
    'SELECT "article_ID", "content" FROM "article" WHERE "article_ID" = \'4\'',
    [],
    function(err, rows) {
      var articles = rows.rows;
      var data = {
...
app.get("/music", function(req, res) {
  ...
  query(
    'SELECT "article_ID", "content" FROM "article" WHERE "article_ID" = \'5\'',
    [],
    function(err, rows) {
      var articles = rows.rows;
      var data = {
...
app.get("/parties", function(req, res) {
  ...
  query(
    'SELECT "article_ID", "content" FROM "article" WHERE "article_ID" = \'6\'',
    [],
    function(err, rows) {
      var articles = rows.rows;
      var data = {
...
app.get("/markets", function(req, res) {
  ...
  query(
    'SELECT "article_ID", "content" FROM "article" WHERE "article_ID" = \'7\'',
    [],
    function(err, rows) {
      var articles = rows.rows;
      var data = {
...
app.post("/addArticle", function(req, res) {
  ...
  form.parse(req, function(err, fields) {
    ...
    query(
      'INSERT INTO "article" ("content", "username") VALUES ($1, $2)',
      [content, username],
      function(err) {
        res.redirect("/");
      }
...
app.get("/edit/:article_ID", function(req, res) {
  if (req.isAuthenticated()) {
    ...
    query(
      'SELECT "content" FROM "article" WHERE "article_ID" = $1',
      [articleID],
      function(err, rows) {
